...
## `dotnet run`
### This might take a while, some webpack deprecation warnings will show up, ignore this. Once you can see the deprecation warnings, the react web is live and can be accessed on https://localhost:5001/ in your browser, initial loading of the app might take a while to completely render.
